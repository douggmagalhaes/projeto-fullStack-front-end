...
export const RegisterSchema = z
  .object({
    ...
    description: z.string().min(1, "A descrição é obrigatório.").max(50, "A descrição deve conter no máximo 300 caracteres."),
    is_seller: z.any(),
    //is_seller: z.string().default(() => "false"),
    //is_seller: z.boolean(),
...
//RegisterEditeSchema, RegisterEditeSchemaData
